...
# build a ANN model with 7 layer fully connected based on optimum number of neurons , batchsize and learning rate 
# extracted from Shallow networks
...
model.save('Deep learning 7 layer fully connected.h5')
...
# loading the model
model = tf.keras.models.load_model('Deep learning 7 layer fully connected.h5')
