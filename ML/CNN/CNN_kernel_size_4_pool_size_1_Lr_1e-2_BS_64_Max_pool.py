...
# Add a 1D convolutional layer with 32 filters, kernel size 4, and activation function 'relu'
model.add(Conv1D(32, kernel_size=4, activation='relu', input_shape=(6, 1)))
