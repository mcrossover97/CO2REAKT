...
# Add a 1D convolutional layer with 32 filters, kernel size 3, and activation function 'relu'
model.add(Conv1D(32, kernel_size=5, activation='relu', input_shape=(6, 1)))
...
# Add the output layer with 1 neuron and activation function 'relu'
...
model.save('CNN_kernel_size_5_pool_size_1_Lr_1e-3.h5')
...
# loading the model
model = tf.keras.models.load_model('CNN_kernel_size_5_pool_size_1_Lr_1e-3.h5')
...
axes[0, 0].set_ylabel("Actual CO2 Solubility (mol/kg)", fontsize=10)
...
axes[0, 1].set_ylabel("Actual CO2 Solubility (mol/kg)", fontsize=10)
...
axes[1, 0].set_ylabel("Actual CO2 Solubility (mol/kg)", fontsize=10)
...
axes[1, 1].set_ylabel("Actual CO2 Solubility (mol/kg)", fontsize=10)
