...
model.save('Model_CNN_Average_Pool.h5')
...
# loading the model
model = tf.keras.models.load_model('Model_CNN_Average_Pool.h5')
...
axes[0, 0].set_xlabel("Actual CO$_2$ solubility (mol/kg)", fontsize=10)
axes[0, 0].set_ylabel("Predicted CO$_2$ solubility (mol/kg)", fontsize=10)
...
axes[0, 1].set_xlabel("Actual CO$_2$ Solubility (mol/kg)", fontsize=10)
axes[0, 1].set_ylabel("Predicted CO$_2$ Solubility (mol/kg)", fontsize=10)
...
sns.regplot(x=y_test, y=testpreds, scatter_kws={'alpha': 0.5, 'color': 'red'}, line_kws={'color': 'red'}, ci=0, ax=axes[1, 0])
sns.scatterplot(x=y_test, y=testpreds, color='black', alpha=0.5, ax=axes[1, 0])
axes[1, 0].set_xlabel("Actual CO$_2$ solubility (mol/kg)", fontsize=15, fontweight='bold')
axes[1, 0].set_ylabel("Predicted CO$_2$ solubility (mol/kg)", fontsize=15, fontweight='bold')
axes[1, 0].set_title("Testing Results")
axes[1, 0].legend(loc='upper left')
# Add R-squared to the bottom right
r_squared_test = r2_score(y_test, testpreds)
axes[1, 0].text(0.95, 0.05, f'R-squared = {r_squared_test:.3f}', ha='right', va='bottom', transform=axes[1, 0].transAxes,fontsize=15)
...
axes[1, 1].set_xlabel("Actual CO$_2$ Solubility (mol/kg)", fontsize=10)
axes[1, 1].set_xlabel("Actual CO$_2$ Solubility (mol/kg)", fontsize=10)
axes[1, 1].set_ylabel("Predicted CO$_2$ Solubility (mol/kg)", fontsize=10)
