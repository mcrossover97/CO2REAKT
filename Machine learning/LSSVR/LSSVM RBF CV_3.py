...
grid_search = GridSearchCV(lssvm_model, param_grid, cv=3, scoring='neg_mean_squared_error')
...
sns.regplot(x=y_test, y=testpreds, scatter_kws={'alpha': 0.5, 'color': 'green'}, line_kws={'color': 'green'}, ci=90, ax=axes[0, 1], label="Testing Regression Line")
...
last_row_features = Train_data.tail(1)
last_row_features
