...
model.save('CNN_kernel_size_6_pool_size_1_Lr_1e-2_BS_64_Max_pool_Dense_128')
...
# loading the model
model = tf.keras.models.load_model('CNN_kernel_size_6_pool_size_1_Lr_1e-2_BS_64_Max_pool_Dense_128')
