...
# build a Shallow model with neurons 200
...
model = Sequential()
model.add(Dense(200, input_shape=(x_train.shape[1],),  activation="relu")) # (features,)
...
# loading the model
model = tf.keras.models.load_model('Model_ANN_200.h5')
