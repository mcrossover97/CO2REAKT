...
# build a Shallow model with learning rate of 1e-6
...
# compile the model
model.compile(optimizer= optimizers.Adam(learning_rate=1e-6) ,loss='mse', metrics=['mae'])
...
model.save('Model_ANN_LR_1e-6.h5')
...
# loading the model
model = tf.keras.models.load_model('Model_ANN_LR_1e-6.h5')
