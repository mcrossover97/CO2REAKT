...
# Perform grid search 
grid_search = GridSearchCV(estimator = model, param_grid=params, cv=2, scoring='neg_mean_squared_error', verbose=1)
...
model.save_model('XGBoost_CV_2.json')  # You can use a .json file format
...
model.load_model('XGBoost_CV_2.json')
