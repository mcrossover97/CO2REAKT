...
# Perform grid search 
grid_search = GridSearchCV(estimator = model, param_grid=params, cv=6, scoring='neg_mean_squared_error', verbose=1)
...
model.save_model('XGBoost_CV_6.json')  # You can use a .json file format
...
model.load_model('XGBoost_CV_6.json')
