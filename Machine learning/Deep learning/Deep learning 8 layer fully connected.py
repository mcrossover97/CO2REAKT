...
# build a ANN model with 5 layer fully connected based on optimum number of neurons , batchsize and learning rate 
...
model.save('Model_ANN_8_layer.h5')
...
# loading the model
model = tf.keras.models.load_model('Model_ANN_8_layer.h5')
